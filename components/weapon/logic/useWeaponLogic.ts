...
import { useWeaponSway } from './useWeaponSway';
import { useGlock17Logic } from './useGlock17Logic';
import { useMakarovLogic } from './useMakarovLogic';
import { useStickLogic } from './useStickLogic';
import { useSonarLogic } from './useSonarLogic';
...
export const useWeaponLogic = ({
    ...
    useFrame((state, deltaRaw) => {
        // Freeze weapon animation/sway if game is not actively playing
